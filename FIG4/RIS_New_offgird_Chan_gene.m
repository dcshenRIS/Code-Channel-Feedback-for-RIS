...
[on_gird_psi,on_gird_psi_index] = On_gird2Off_gird(psi,Mindex_long);
...
%           Error  on_gird_Hss(:,:,i_K)=on_gird_Hss(:,:,i_K)+sqrt(N/L2)*sqrt(M*N/L1)*ALPHA1(i_L2,i_K)*ALPHA2(i_L1,1)*diag((on_gird_A1(:,i_K,i_L2))')*on_gird_A2(:,i_L1)*(on_gird_B_steering(:,i_L1))';
